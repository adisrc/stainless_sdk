...
export const tool: Tool = {
  name: 'retrieve_product_pricings',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nList Product Pricing\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/product_pricing_retrieve_response',\n  $defs: {\n    product_pricing_retrieve_response: {\n      allOf: [        {\n          $ref: '#/$defs/success'\n        }\n      ]\n    },\n    success: {\n      type: 'object',\n      properties: {\n        data: {\n          type: 'object',\n          additionalProperties: true\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      product_id: {
...
export const handler = async (client: TestWiz, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.productPricings.retrieve(product_id)));
};
