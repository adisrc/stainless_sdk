...
const fuse = new Fuse(
  [
    ...
    'client.customers.addresses.create',
    'client.customers.addresses.delete',
    'client.customers.addresses.list',
    'client.customers.addresses.retrieve',
    'client.customers.addresses.update',
    'client.customers.contacts.create',
    'client.customers.contacts.delete',
    'client.customers.contacts.list',
    'client.customers.contacts.retrieve',
    'client.customers.contacts.update',
    'client.inventories.createOrUpdate',
    ...
    'client.priceLists.create',
    'client.priceLists.delete',
    'client.priceLists.list',
    'client.priceLists.retrieve',
    'client.priceLists.update',
    'client.productPricings.retrieve',
    'client.productPricings.update',
    'client.products.create',
    'client.products.list',
    'client.products.retrieve',
    'client.products.update',
    'client.salesReps.list',
    'client.shipments.create',
    'client.shipments.delete',
